  ...
  template: `
    <div class="add-user-container">
      ...
      <div class="form-container">
        <form (ngSubmit)="onSubmit()" #citoyenForm="ngForm">
          ...
          <div class="form-group">
            ...
            <input
              ...
              id="nina"
              name="nina"
              [(ngModel)]="citoyen.nina"
              required
              #nina="ngModel"
              class="form-control"
            />
            <div class="invalid-feedback" *ngIf="nina.invalid && (nina.dirty || nina.touched)">
          ...
          <div class="form-actions">
            ...
            <button type="submit" class="btn btn-primary" [disabled]="citoyenForm.invalid || isSubmitting">
              {{ isSubmitting ? 'Création en cours...' : 'Créer le citoyen' }}
            </button>
          </div>
...
export class AddCitoyenComponent {
  ...
  onSubmit(): void {
    ...
    this.userService.createCitoyen(this.citoyen).subscribe({
      next: () => {
        this.successMessage = "Le citoyen a été créé avec succès."
        this.isSubmitting = false
        this.citoyen = new Citoyen() // Réinitialiser le formulaire
        setTimeout(() => {
          this.router.navigate(["/admin/users"])
        }, 2000)
      },
      error: (error) => {
        this.errorMessage = "Une erreur est survenue lors de la création du citoyen."
        this.isSubmitting = false
